...
(function () {
    ...
    function load() {
        ...
        if (!inArray(excludes, 'leaflet')) {
            inputCSS('/wulumuqilsH5/assets/static/supermapLeaflet/dist/leaflet/leaflet.css');
            inputScript('/wulumuqilsH5/assets/static/supermapLeaflet/dist/leaflet/leaflet.js');
        }
        ...
        if (inArray(includes, 'echarts')) {
            inputScript('/wulumuqilsH5/assets/static/supermapLeaflet/dist/leaflet/dist/echarts.min.js');
        }
        ...
        if (!inArray(excludes, 'iclient-leaflet')) {
            if (supportES6()) {
                inputScript('/wulumuqilsH5/assets/static/supermapLeaflet/dist/leaflet/iclient-leaflet-es6.min.js');
            } else {
                inputScript('/wulumuqilsH5/assets/static/supermapLeaflet/dist/leaflet/iclient-leaflet.min.js');
            }
        }
        if (inArray(includes, 'iclient-leaflet-css')) {
            inputCSS('/wulumuqilsH5/assets/static/supermapLeaflet/dist/leaflet/iclient-leaflet.min.css');
        }
        ...
        if (inArray(includes, 'iclient-leaflet-vue')) {
            inputCSS('/wulumuqilsH5/assets/static/supermapLeaflet/dist/leaflet/iclient-leaflet-vue.css');
            inputScript('/wulumuqilsH5/assets/static/supermapLeaflet/dist/leaflet/iclient-leaflet-vue.min.js');
        }
